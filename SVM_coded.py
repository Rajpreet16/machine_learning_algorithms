...
class Support_Vector_Machine:
    ...
    def predict(self, features):
        ...
        if classification !=0 and self.visualization:b 
            plt.scatter(features[0], features[1], s=200, marker='*', c=self.colors[classification])
    ...
    def visualize(self):
        ...
        datarange = (self.min_feature_value*0.9, self.ax_feature_value*1.1)
        ...
        self.ax.plot([hyper_x_min,hyper_x_max],[nsv1,nsv2], 'y--')
        ...
        self.ax.plot([hyper_x_min,hyper_x_max],[db1,db2])
